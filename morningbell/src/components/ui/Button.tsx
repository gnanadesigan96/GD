    ...
    return (
      <button
        ...
        className={cn(
          ...
          {
            'bg-amber-500 text-white hover:bg-amber-600 active:bg-amber-700': variant === 'primary',
            'bg-white text-amber-700 border border-amber-300 hover:bg-amber-50': variant === 'secondary',
